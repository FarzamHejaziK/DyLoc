...
model = tf.keras.models.load_model('KNNCNNW1/Weights-109--0.92692.hdf5')
...
for i in range(0,1000):
    ...
    test_series2 = np.reshape(CLADPNL_series[i,:,:,:],(20,64,64))
    test_series3 = np.reshape(CLADPANL_series[i,:,:,:],(20,64,64))
